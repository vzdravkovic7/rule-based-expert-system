...
public class ServiceApplication {
	...
	// new Korisnik(4L, "Petar", 45, 175.0, 80.0, 118, 78, 1000.0,
	// "OPSTA_KONDICIJA"),
	...
	// System.out.println("=======================================================");
	// System.out.println("BMI: " + k.getBmiKategorija() + " | Pritisak: " +
	// k.getPritisakKategorija()
	// + " | Aktivnost: " + k.getNivoAktivnosti());

	// if (nadjeniPlan != null) {
	// System.out.println("Trening plan: " + nadjeniPlan.getKardioDani() + "x
	// Kardio, "
	...
	// System.out.println(
	// "Kalorije cilj: " + String.format("%.0f", nadjeniNutri.getCiljaneKalorije())
	// + " kcal");
	// System.out.println("Status unosa hrane: "
	// + (nadjeniNutri.getKomentarUnosa() != null ? nadjeniNutri.getKomentarUnosa()
	// : "OK"));
	// }
	// System.out.println("=======================================================\n");
